...
public class HBaseThriftPoolSingleTests {
  ...
  public void testThriftClient() {
    ...
    final HBaseRowData rowData =
        hBaseThriftService.getRow("LEO_USER", GetRowParam.of("a10001").build());
  ...
  public void testDeleteBatchWithFamilyAndCol() {
    ...
    hBaseThriftService.deleteBatch("LEO_USER", Arrays.asList("a10001", "a10002"), "f",
