...
import com.hydraql.thrift.model.UserModel;
...
public class HBaseThriftTemplateTest extends BaseHBaseThriftTemplateTest {
  ...
  public void testGetRows() {
    // List<UserModel> userModels = thriftTemplate.getRows(Arrays.asList("u10001", "u21000",
    // "u22000"), UserModel.class);
    // System.out.println(userModels);
    // List<UserModel> userModels2 = thriftTemplate.getRows(Arrays.asList("u10001", "u21000",
    // "u22000"),
    // "detail", UserModel.class);
    // System.out.println(userModels2);
    // List<UserModel> userModels3 = thriftTemplate.getRows(Arrays.asList("u10001", "u21000",
    // "u22000"),
  ...
  public void testScanWithLimit() {
    ScanParams queryParams = ScanParams.of().limit(2).build();
    // 全表扫描所有数据，并设置limit
  ...
  public void testScanWithStarAndRow() {
    ...
    ScanParams queryParams = ScanParams.of().startRow("u10001").stopRow("u21000").build();
  ...
  public void testScanWithFilter() {
    ...
    ScanParams queryParams = ScanParams.of().filter(new IHBaseFilter<String>() {
      @Override
