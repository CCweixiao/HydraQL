 ...
 */
public class SelectExecutor extends BaseHqlExecutor<Boolean> implements Interpreter<Boolean> {
    ...
    private static class ExecutorBuilder extends Builder<SelectExecutor, Boolean> {
