...
public final class FieldValue implements Comparable<FieldValue> {
  ...
  private org.apache.hadoop.hbase.Size optimizeSize(org.apache.hadoop.hbase.Size size) {
    if (size.get(org.apache.hadoop.hbase.Size.Unit.BYTE) < 1024d) {
      return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.BYTE ? size
          : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.BYTE),
              org.apache.hadoop.hbase.Size.Unit.BYTE);
    } else if (size.get(org.apache.hadoop.hbase.Size.Unit.KILOBYTE) < 1024d) {
      return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.KILOBYTE ? size
          : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.KILOBYTE),
              org.apache.hadoop.hbase.Size.Unit.KILOBYTE);
    } else if (size.get(org.apache.hadoop.hbase.Size.Unit.MEGABYTE) < 1024d) {
      return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.MEGABYTE ? size
          : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.MEGABYTE),
              org.apache.hadoop.hbase.Size.Unit.MEGABYTE);
    } else if (size.get(org.apache.hadoop.hbase.Size.Unit.GIGABYTE) < 1024d) {
      return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.GIGABYTE ? size
          : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.GIGABYTE),
              org.apache.hadoop.hbase.Size.Unit.GIGABYTE);
    } else if (size.get(org.apache.hadoop.hbase.Size.Unit.TERABYTE) < 1024d) {
      return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.TERABYTE ? size
          : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.TERABYTE),
              org.apache.hadoop.hbase.Size.Unit.TERABYTE);
    }
    return size.getUnit() == org.apache.hadoop.hbase.Size.Unit.PETABYTE ? size
        : new org.apache.hadoop.hbase.Size(size.get(org.apache.hadoop.hbase.Size.Unit.PETABYTE),
            org.apache.hadoop.hbase.Size.Unit.PETABYTE);
  }
  ...
  private org.apache.hadoop.hbase.Size parseSizeString(String sizeString) {
    ...
    return new org.apache.hadoop.hbase.Size(Double.parseDouble(valueString),
        convertToUnit(unitSimpleName));
  }
  ...
  public int compareTo(FieldValue o) {
    ...
    switch (type) {
      ...
      case SIZE:
        return ((org.apache.hadoop.hbase.Size) value)
            .compareTo((org.apache.hadoop.hbase.Size) o.value);
