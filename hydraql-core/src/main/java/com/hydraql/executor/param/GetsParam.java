 ...
 */
public class GetsParam extends QueryParam<GetsParam> {
  private final List<byte[]> rows;

  private GetsParam(Builder builder) {
    super(builder);
    this.rows = builder.rows;
  }

  public static GetsParam.Builder created(List<byte[]> rows) {
    if (null == rows) {
  ...
  public static GetsParam.Builder create() {
    return new Builder();
  }

  public static class Builder extends QueryParam.Builder<GetsParam> {
