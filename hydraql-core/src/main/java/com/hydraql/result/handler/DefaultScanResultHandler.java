...
/**
 * @author leojie@apache.org 2024/11/17 19:00
 */
public class DefaultScanResultHandler implements ScanResultHandler<ScanResult> {
  @Override
  public <RS> ScanResult handleResult(RS rs) throws Exception {
    if (rs == null) {
      return null;
    }
    ...
    try (ResultScanner resultScanner = (ResultScanner) rs) {
      for (Result result : resultScanner) {
        ...
        scanResult.appendValue(getResult);
      }
    }
    return scanResult;
  }
