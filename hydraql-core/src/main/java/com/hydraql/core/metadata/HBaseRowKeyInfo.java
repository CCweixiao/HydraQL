...
public class HBaseRowKeyInfo extends HBaseFieldInfo {
  ...
  public static class Builder extends HBaseFieldInfo.Builder<HBaseRowKeyInfo> {
    ...
    @Override
    HBaseRowKeyInfo build() {
      return new HBaseRowKeyInfo(this);
    }
  }
