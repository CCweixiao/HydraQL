 ...
 */
public class HBaseQualifierInfo extends HBaseFieldInfo {
  ...
  private HBaseQualifierInfo(HBaseQualifierInfo.Builder builder) {
    super(builder);
  ...
  public static HBaseQualifierInfo.Builder newBuilder(Class<?> type, String rowName) {
    return new HBaseQualifierInfo.Builder(type, rowName);
  }

  public static class Builder extends HBaseFieldInfo.Builder<HBaseQualifierInfo> {
    ...
    HBaseQualifierInfo build() {
      ...
      return new HBaseQualifierInfo(this);
    }
  }
