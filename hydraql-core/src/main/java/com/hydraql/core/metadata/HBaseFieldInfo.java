 ...
 */
public abstract class HBaseFieldInfo implements Serializable {
  ...
  protected HBaseFieldInfo(Builder<?> builder) {
  ...
  public abstract static class Builder<T extends HBaseFieldInfo> {
    private final String name;
