...
import com.hydraql.core.exceptions.HBaseSdkUnsupportedAuthTypeException;
...
public enum AuthType {
  ...
  public static AuthType findAuthType(String authType) {
    ...
    throw new HBaseSdkUnsupportedAuthTypeException(
        String.format("Unsupported auth type %s", authType));
  }
