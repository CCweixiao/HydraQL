...
public class HBaseAutoConfiguration {
  ...
  private Properties createHBaseProperties() {
    ...
    if (StringUtil.isBlank(this.properties.getZkQuorum())) {
      properties.setProperty(HydraQlClientConfigKeys.ZOOKEEPER_QUORUM,
        HydraQlClientConfigKeys.LOCAL_HOST_ZOOKEEPER_QUORUM);
    } else {
      properties.setProperty(HydraQlClientConfigKeys.ZOOKEEPER_QUORUM,
        this.properties.getZkQuorum());
    }
    if (StringUtil.isNotBlank(this.properties.getZkClientPort())) {
      properties.setProperty(HydraQlClientConfigKeys.ZOOKEEPER_CLIENT_PORT,
        this.properties.getZkClientPort());
    }
    if (StringUtil.isNotBlank(this.properties.getDfsRootDir())) {
      properties.setProperty(HydraQlClientConfigKeys.HBASE_DFS_ROOT_DIR,
        this.properties.getDfsRootDir());
    }
    if (StringUtil.isNotBlank(this.properties.getZkNodeParent())) {
      properties.setProperty(HydraQlClientConfigKeys.ZOOKEEPER_NODE_PARENT,
        this.properties.getZkNodeParent());
    }
    AuthType defaultAuthType = AuthType.findAuthType(this.properties.getSecurityAuthWay());
    properties.setProperty(HydraQlClientConfigKeys.HBASE_SECURITY_AUTH,
      defaultAuthType.getAuthType());
    ...
    if (defaultAuthType == AuthType.KERBEROS) {
      ...
      properties.setProperty(HydraQlClientConfigKeys.KERBEROS_PRINCIPAL,
      ...
      properties.setProperty(HydraQlClientConfigKeys.KERBEROS_KEYTAB_FILE,
        this.properties.getKeytabFilePath());
      properties.setProperty(HydraQlClientConfigKeys.KERBEROS_PROXY_USER,
      ...
      properties.setProperty(HydraQlClientConfigKeys.HBASE_REGION_SERVER_KERBEROS_PRINCIPAL,
      ...
      properties.setProperty(HydraQlClientConfigKeys.HBASE_MASTER_KERBEROS_PRINCIPAL,
        this.properties.getMasterKerberosPrincipal());

      if (StringUtil.isNotBlank(this.properties.getKrb5ConfPath())) {
        properties.setProperty(HydraQlClientConfigKeys.KRB5_CONF_PATH,
          this.properties.getKrb5ConfPath());
      } else {
        properties.setProperty(HydraQlClientConfigKeys.KRB5_REALM, this.properties.getKrb5Realm());
        properties.setProperty(HydraQlClientConfigKeys.KRB5_KDC_SERVER_ADDR,
