...
/**
 * A CounterGenerator that reports generated integers via lastInt() only after they have been
 * acknowledged.
 */
public class AcknowledgedCounterGenerator extends CounterGenerator {
  ...
  /**
   * In this generator, the highest acknowledged counter value (as opposed to the highest generated
   * counter value).
   */
  @Override
