...
public class HotspotIntegerGenerator extends NumberGenerator {
   ...
   */
  public HotspotIntegerGenerator(long lowerBound, long upperBound, double hotsetFraction,
    ...
    if (lowerBound > upperBound) {
      System.err.println(
        "Upper bound of Hotspot generator smaller than the lower bound. " + "Swapping the values.");
