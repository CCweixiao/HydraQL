...
public class SequentialGenerator extends NumberGenerator {
  ...
  /**
   * If the generator returns numeric (long) values, return the next value as an long. Default is to
   * return -1, which is appropriate for generators that do not return numeric values.
   */
