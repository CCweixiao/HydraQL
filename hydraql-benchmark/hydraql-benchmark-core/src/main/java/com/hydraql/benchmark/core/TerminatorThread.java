...
/**
 * A thread that waits for the maximum specified time and then interrupts all the client threads
 * passed at initialization of this thread. The maximum execution time passed is assumed to be in
 * seconds.
 */
